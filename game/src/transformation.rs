use nalgebra_glm::{quat_angle_axis, quat_to_mat4, vec3, vec4, vec4_to_vec3, Quat, Vec3};
...
pub fn rotate_around_local_axis(
    ...
    orientation
        * quat_angle_axis(around_x, &vec3(1.0, 0.0, 0.0))
        * quat_angle_axis(around_y, &vec3(0.0, 1.0, 0.0))
        * quat_angle_axis(around_z, &vec3(0.0, 0.0, 1.0))
}
